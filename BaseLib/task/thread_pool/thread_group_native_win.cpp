...
namespace base::internal {
	...
	public:
		ScopedCallbackMayRunLongObserver(PTP_CALLBACK_INSTANCE callback) : callback_(callback) {
	...
	// static
	void CALLBACK ThreadGroupNativeWin::RunNextTaskSource(PTP_CALLBACK_INSTANCE callback_instance,
		void* thread_group_windows_impl, PTP_WORK) {
