...
#include "task/sequence_manager/tasks.h"
#include "time/time.h"
	...
	namespace sequence_manager {
		...
		public:
			...
			public:
				...
				// called on |queue|.
				//
				// TODO(altimin): Make it std::optional<TimeTicks> to tell
			...
			// NOTE: this must be called on the thread this TaskQueue was created by.
			std::optional<TimeTicks> GetNextScheduledWakeUp() const;
			...
			void SetQueuePriority(QueuePriority priority) const;
			...
			void InsertFence(InsertFencePosition position) const;
			...
			void SetShouldReportPostedTasksWhenDisabled(bool should_report) const;
