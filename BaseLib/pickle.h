...
namespace base
{
	...
	public:
		...
		bool ReadStringPiece(std::string_view* result) WARN_UNUSED_RESULT;
		bool ReadString16(std::wstring* result) WARN_UNUSED_RESULT;
		// The StringPiece16 data will only be valid for the lifetime of the message.
		bool ReadStringPiece16(std::wstring_view* result) WARN_UNUSED_RESULT;
	...
	public:
		...
		void WriteString16(const std::wstring_view& value);
