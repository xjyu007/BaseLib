...
namespace base {
	...
	public:
		...
		[[nodiscard]] virtual const unsigned char* front() const = 0;

		// Size of the memory pointed to.
		[[nodiscard]] virtual size_t size() const = 0;

		// Returns true if |other| is byte for byte equal.
		[[nodiscard]] bool Equals(const scoped_refptr<RefCountedMemory>& other) const;
	...
	public:
		...
		// RefCountedMemory:
		[[nodiscard]] const unsigned char* front() const override;
	...
	public:
		...
		[[nodiscard]] const std::vector<unsigned char>& data() const { return data_; }
