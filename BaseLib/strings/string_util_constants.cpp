...
const wchar_t kWhitespaceUTF16[] = {WHITESPACE_UNICODE, 0};
const wchar_t kWhitespaceNoCrLfUTF16[] = {WHITESPACE_UNICODE_NO_CR_LF, 0};
const char kWhitespaceASCII[] = {WHITESPACE_ASCII, 0};
const wchar_t kWhitespaceASCIIAs16[] = {WHITESPACE_ASCII, 0};
