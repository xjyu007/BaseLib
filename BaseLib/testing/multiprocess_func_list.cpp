...
namespace multi_process_function_list {
	...
	namespace {
		...
		struct ProcessFunctions {
			...
			ProcessFunctions(TestMainFunctionPtr main, SetupFunctionPtr setup) : main(main), setup(setup) {}
	...
	AppendMultiProcessTest::AppendMultiProcessTest(std::string test_name, TestMainFunctionPtr main_func_ptr, SetupFunctionPtr setup_func_ptr) {
		GetMultiprocessFuncMap()[test_name] = ProcessFunctions(main_func_ptr, setup_func_ptr);
	}
