...
namespace logging {
	...
	extern BASE_EXPORT const GUID kLogEventId;
	...
	public:
		...
		static bool LogMessage(LogSeverity severity, const char* file,
			int line, size_t message_start, const std::string& message);
