	...
	namespace sequence_manager {
		namespace internal {
			...
			public:
				...
				virtual void WillQueueTask(PendingTask* pending_task, const char* task_queue_name) = 0;
				...
				virtual const scoped_refptr<AssociatedThreadId>& GetAssociatedThread() const = 0;
			};
