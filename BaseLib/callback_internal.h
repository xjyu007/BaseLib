...
namespace base {
	...
	namespace internal {
		...
		public:
			...
			[[nodiscard]] bool is_null() const { return !bind_state_; }
		...
		protected:
			...
			[[nodiscard]] bool EqualsInternal(const CallbackBase& other) const;
			...
			[[nodiscard]] InvokeFuncStorage polymorphic_invoke() const {
