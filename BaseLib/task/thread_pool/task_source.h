	...
	namespace internal {
		...
		public:
			...
			public:
				...
				std::optional<Task> TakeTask(RunIntent* intent) WARN_UNUSED_RESULT;
			    ...
			    std::optional<Task> Clear(RunIntent intent) WARN_UNUSED_RESULT;
		...
		protected:
			...
			virtual std::optional<Task> TakeTask() = 0;
