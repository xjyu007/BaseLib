...
namespace base {
	...
	public:
		...
		typedef std::basic_string_view<StringType::value_type> StringPieceType;
		...
		FilePath InsertBeforeExtensionASCII(std::string_view suffix) const WARN_UNUSED_RESULT;
		...
		FilePath AddExtensionASCII(std::string_view extension) const WARN_UNUSED_RESULT;
		...
		[[nodiscard]] bool MatchesExtension(StringPieceType extension) const;
		...
		[[nodiscard]] std::wstring LossyDisplayName() const;

		// Return the path as ASCII, or the empty string if the path is not ASCII.
		// This should only be used for cases where the FilePath is representing a
		// known-ASCII filename.
		[[nodiscard]] std::string MaybeAsASCII() const;
		...
		[[nodiscard]] std::string AsUTF8Unsafe() const;

		// Similar to AsUTF8Unsafe, but returns UTF-16 instead.
		[[nodiscard]] std::wstring AsUTF16Unsafe() const;
		...
		static FilePath FromUTF16Unsafe(std::wstring_view utf16);
