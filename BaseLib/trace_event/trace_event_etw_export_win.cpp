...
#include "trace_event/etw_manifest/chrome_events_win.h"  // NOLINT
...
namespace {
	...
	static void __stdcall EtwEnableCallback(LPCGUID SourceId,
		...
		// CHROME_Context.
		McGenControlCallbackV2(SourceId, ControlCode, Level, MatchAnyKeyword, MatchAllKeyword, FilterData, CallbackContext);
