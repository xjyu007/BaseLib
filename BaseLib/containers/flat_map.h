...
#include "containers/flat_tree.h"
#include "logging.h"
...
namespace base {
	...
	class flat_map : public internal::flat_tree<
		Key,
		std::pair<Key, Mapped>,
		internal::GetKeyFromValuePairFirst<Key, Mapped>,
		Compare> {
	private:
		using tree = typename internal::flat_tree<
			Key,
			std::pair<Key, Mapped>,
			internal::GetKeyFromValuePairFirst<Key, Mapped>,
			Compare>;
