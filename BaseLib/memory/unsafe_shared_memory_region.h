...
namespace base {
	...
	public:
		...
		// mojo/public/cpp/shared_memory_utils.h for creating a shared memory
		...
		static UnsafeSharedMemoryRegion CreateFromHandle(const base::SharedMemoryHandle& handle);
	...
	private:
		//FRIEND_TEST_ALL_PREFIXES(DiscardableSharedMemoryTest, LockShouldFailIfPlatformLockPagesFails);
