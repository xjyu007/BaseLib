...
namespace base {
	...
	namespace internal {
		...
		public:
			...
			[[nodiscard]] bool ContainsPromiseExecutor() const {
				return type_ops_.GetState() == State::PROMISE_EXECUTOR;
			}

			[[nodiscard]] bool ContainsCurriedPromise() const {
				return type_ops_.GetState() == State::CURRIED_PROMISE;
			}

			[[nodiscard]] bool ContainsResolved() const {
				return type_ops_.GetState() == State::RESOLVED;
			}

			[[nodiscard]] bool ContainsRejected() const {
