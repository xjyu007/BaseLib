...
namespace base {
	...
	public:
		...
		// immediately.
		void AddDestructionObserver(DestructionObserver* destruction_observer) const;

		// Remove a DestructionObserver.  It is safe to call this method while a
		// DestructionObserver is receiving a notification callback.
		void RemoveDestructionObserver(DestructionObserver* destruction_observer) const;
		...
		// posted tasks.
		void SetAddQueueTimeToTasks(bool enable) const;
		...
		void SetNestableTasksAllowed(bool allowed) const;
