...
namespace base {
	namespace win {
		...
		public:
			...
			LONG ReadValues(const wchar_t* name, std::vector<std::wstring>* values) const;
			...
			LONG WriteValue(const wchar_t* name, DWORD in_value) const;

			// Sets a string value.
			LONG WriteValue(const wchar_t* name, const wchar_t* in_value) const;
			...
			[[nodiscard]] HKEY Handle() const { return key_; }
		...
		public:
			...
			[[nodiscard]] DWORD ValueCount() const;
			...
			[[nodiscard]] const wchar_t* Name() const { return name_.c_str(); }
			[[nodiscard]] const wchar_t* Value() const { return value_.data(); }
			// ValueSize() is in bytes.
			[[nodiscard]] DWORD ValueSize() const { return value_size_; }
			[[nodiscard]] DWORD Type() const { return type_; }
		...
		public:
			...
			[[nodiscard]] DWORD SubkeyCount() const;
			...
			[[nodiscard]] const wchar_t* Name() const { return name_; }
