...
namespace base {
	...
	public:
		...
		//
		// DEPRECATED - Do not use in new code. http://crbug.com/634507
		[[nodiscard]] constexpr int64_t ToInternalValue() const { return delta_; }

		// Returns the magnitude (absolute value) of this TimeDelta.
		[[nodiscard]] constexpr TimeDelta magnitude() const {
		...
		[[nodiscard]] constexpr bool is_zero() const { return delta_ == 0; }
#undef max
...
#undef min
		...
		[[nodiscard]] int InMinutes() const;
		[[nodiscard]] double InSecondsF() const;
		[[nodiscard]] int64_t InSeconds() const;
		...
		[[nodiscard]] constexpr int64_t InMicroseconds() const { return delta_; }
	...
	namespace time_internal {
		...
		public:
			...
			[[nodiscard]] constexpr bool is_null() const { return us_ == 0; }
			...
			[[nodiscard]] constexpr int64_t ToInternalValue() const { return us_; }
			...
			[[nodiscard]] constexpr TimeDelta since_origin() const {
	...
	public:
		...
		[[nodiscard]] TimeDelta ToDeltaSinceWindowsEpoch() const;
		...
		[[nodiscard]] double ToJsTime() const;
		...
		[[nodiscard]] Time UTCMidnight() const { return Midnight(false); }
		[[nodiscard]] Time LocalMidnight() const { return Midnight(true); }
	...
	private:
		...
		[[nodiscard]] Time Midnight(bool is_local) const;
