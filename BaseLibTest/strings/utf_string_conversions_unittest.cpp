...
namespace base {
	...
	TEST(UTFStringConversionsTest, ConvertMultiString) {
		...
		std::wstring multistring16;
		memcpy(WriteInto(&multistring16, base::size(multi16)), multi16,	sizeof(multi16));
		...
		const std::string& converted = WideToUTF8(multistring16);
