...
namespace base {
	...
	void Base64UrlEncode(const std::string_view& input, Base64UrlEncodePolicy policy, std::string* output) {
	...
	bool Base64UrlDecode(const std::string_view& input, Base64UrlDecodePolicy policy, std::string* output) {
