...
namespace base {
	...
	//
	//
	template <class str, class const_iterator, class ch>
	...
	public:
		...
		std::basic_string_view<ch> token_piece() const {
			return std::basic_string_view<ch>(&*token_begin_,
	...
	typedef StringTokenizerT<std::string, std::string::const_iterator, char> StringTokenizer;
	typedef StringTokenizerT<std::wstring, std::wstring::const_iterator, wchar_t> WStringTokenizer;
	typedef StringTokenizerT<std::string, const char*, char> CStringTokenizer;
