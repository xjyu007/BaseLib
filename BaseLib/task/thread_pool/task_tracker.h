...
namespace base {
	...
	namespace internal {
		...
		private:
			...
			bool BeforeQueueTaskSource(TaskShutdownBehavior shutdown_behavior) const;
			...
			bool BeforeRunTask(TaskShutdownBehavior shutdown_behavior) const;
			...
			void DecrementNumItemsBlockingShutdown() const;
