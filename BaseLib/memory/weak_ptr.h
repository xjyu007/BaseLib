...
namespace base {
	...
	namespace internal {
		...
		public:
			...
			public:
				...
				[[nodiscard]] bool MaybeValid() const;
		...
		public:
			...
			[[nodiscard]] WeakReference GetRef() const;

			[[nodiscard]] bool HasRefs() const { return !flag_->HasOneRef(); }
	...
	public:
		...
		[[nodiscard]] bool MaybeValid() const { return ref_.MaybeValid(); }
		...
		[[nodiscard]] bool WasInvalidated() const { return ptr_ && !ref_.IsValid(); }
	...
	public:
		...
		void InvalidateWeakPtrs() const {
			DCHECK(ptr_);
			weak_reference_owner_.Invalidate();
		}

		// Call this method to determine if any weak pointers exist.
		[[nodiscard]] bool HasWeakPtrs() const {
			DCHECK(ptr_);
