...
namespace base {
	...
	public:
		...
		[[nodiscard]] bool IsValid() const { return index_ != kInvalidIndex; }
	...
	template <typename T,
		...
		public:
			...
			[[nodiscard]] bool empty() const { return impl_.heap_.empty(); }
	...
	public:
		...
		[[nodiscard]] HeapHandle* handle() const { return handle_.get(); }
		...
		[[nodiscard]] HeapHandle GetHeapHandle() const {
			if (handle_)
				return *handle_;
