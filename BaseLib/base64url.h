...
namespace base {
	...
	BASE_EXPORT void Base64UrlEncode(const std::string_view& input, Base64UrlEncodePolicy policy, std::string* output);
	...
	BASE_EXPORT bool Base64UrlDecode(const std::string_view& input, Base64UrlDecodePolicy policy, std::string* output) WARN_UNUSED_RESULT;
