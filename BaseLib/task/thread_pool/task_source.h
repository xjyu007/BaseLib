...
namespace base {
    ...
    SequenceSortKey GetSortKey() const;
		...
		protected:
			...
			virtual std::optional<Task> TakeTask(TaskSource::Transaction* transaction) = 0;
		...
		public:
			...
			std::optional<Task> TakeTask(TaskSource::Transaction* transaction = nullptr)
				WARN_UNUSED_RESULT;
			...
			// of a transaction.
			std::optional<Task> Clear(TaskSource::Transaction* transaction = nullptr)
				WARN_UNUSED_RESULT;
