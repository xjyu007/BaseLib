...
namespace base {
	...
	namespace i18n {
		...
		const wchar_t kRightToLeftMark = 0x200F;
		const wchar_t kLeftToRightMark = 0x200E;
		const wchar_t kLeftToRightEmbeddingMark = 0x202A;
		const wchar_t kRightToLeftEmbeddingMark = 0x202B;
		const wchar_t kPopDirectionalFormatting = 0x202C;
		const wchar_t kLeftToRightOverride = 0x202D;
		const wchar_t kRightToLeftOverride = 0x202E;
		...
		BASE_I18N_EXPORT TextDirection GetFirstStrongCharacterDirection(const std::wstring& text);
		BASE_I18N_EXPORT TextDirection GetLastStrongCharacterDirection(const std::wstring& text);
		...
		BASE_I18N_EXPORT TextDirection GetStringDirection(const std::wstring& text);
		...
		BASE_I18N_EXPORT bool AdjustStringForLocaleDirection(std::wstring* text);

		// Undoes the actions of the above function (AdjustStringForLocaleDirection).
		BASE_I18N_EXPORT bool UnadjustStringForLocaleDirection(std::wstring* text);
		...
		// |text|.
		BASE_I18N_EXPORT void EnsureTerminatedDirectionalFormatting(std::wstring* text);
		...
		BASE_I18N_EXPORT void SanitizeUserSuppliedString(std::wstring* text);
		...
		// BiDi character type.
		BASE_I18N_EXPORT bool StringContainsStrongRTLChars(const std::wstring& text);
		...
		BASE_I18N_EXPORT void WrapStringWithLTRFormatting(std::wstring* text);
		...
		BASE_I18N_EXPORT void WrapStringWithRTLFormatting(std::wstring* text);
		...
		BASE_I18N_EXPORT std::wstring GetDisplayStringInLTRDirectionality(const std::wstring& text) WARN_UNUSED_RESULT;
		...
		// pair.
		BASE_I18N_EXPORT std::wstring StripWrappingBidiControlCharacters(const std::wstring& text) WARN_UNUSED_RESULT;
