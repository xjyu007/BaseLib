...
namespace base
{
	...
	BASE_EXPORT bool IsValidGUID(std::string_view guid);
	BASE_EXPORT bool IsValidGUID(std::wstring_view guid);
	...
	// case characters.
	BASE_EXPORT bool IsValidGUIDOutputString(std::string_view guid);
