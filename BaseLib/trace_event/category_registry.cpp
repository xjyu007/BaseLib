...
#include "trace_event/category_registry.h"
#include <cstring>
#include <type_traits>
...
namespace base::trace_event
{
		...
		// static
		base::subtle::AtomicWord CategoryRegistry::category_index_ = BuiltinCategories::Size();
		...
		bool CategoryRegistry::GetOrCreateCategoryLocked(const char* category_name, CategoryInitializerFn category_initializer_fn,
