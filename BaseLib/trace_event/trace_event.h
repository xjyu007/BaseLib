...
#include "trace_event/trace_arguments.h"
...
namespace trace_event_internal {
	...
	public:
		...
		public:
			...
			[[nodiscard]] unsigned long long raw_id() const { return raw_id_; }
		private:
		...
		public:
			...
			[[nodiscard]] unsigned long long raw_id() const { return raw_id_; }
			[[nodiscard]] const char* scope() const { return scope_; }
			[[nodiscard]] bool has_prefix() const { return has_prefix_; }
			[[nodiscard]] unsigned long long prefix() const { return prefix_; }
			[[nodiscard]] unsigned int id_flags() const { return id_flags_; }

		private:
			const char* scope_ = nullptr;
			bool has_prefix_ = false;
			unsigned long long prefix_ = 0;
			unsigned long long raw_id_ = 0;
		...
		[[nodiscard]] std::unique_ptr<base::trace_event::ConvertableToTraceFormat>
	...
	static inline base::trace_event::TraceEventHandle AddTraceEvent(
		...
		const char* arg1_name,
		ARG1_TYPE&& arg1_val) {
		auto thread_id = static_cast<int>(base::PlatformThread::CurrentId());
		auto now = TRACE_TIME_TICKS_NOW();
		return AddTraceEventWithThreadIdAndTimestamp(
			phase, category_group_enabled, name, scope, id, thread_id, now, flags,
